...
;Test #4
(begin (print 2) (print 3) nil)
; expect ()

;Test #5
(define (make_multiple x) (lambda (y) (* x y)))
; expect make_multiple
(define double (make_multiple 2))
;expect double
(double 5)
;expect 10
