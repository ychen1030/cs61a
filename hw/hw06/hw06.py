...
def make_joint(withdraw, old_password, new_password):
    ...
    """
    "*** YOUR CODE HERE ***"
    def withdraw_new(amount, attemp):
        if attemp == new_password:
            attemp = old_password
        return withdraw(amount, attemp)
...
class VendingMachine:
    ...
    def vend(self):
        if self.num == 0:
            ...
            self.num -= 1
            if change == 0:
                return 'Here is your {}.'.format(self.sku)
            else:
                return 'Here is your {} and ${} change.'.format(self.sku, change)

    def restock(self, amount):
        self.num += amount
        return 'Current {} stock: {}'.format(self.sku, self.num)
